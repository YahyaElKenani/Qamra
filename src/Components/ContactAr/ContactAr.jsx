    ...
    return ( 
        ...
        className="contact-page-container contact-page-container-ar ar-text d-flex flex-column gap-5 align-items-center"> 
            ...
            <form className='d-flex flex-column gap-3 w-100 align-items-center'> 
                ...
                <input type="email" name="" id="user-email"  onChange={(e) => setEmail(e.target.value)}/>
                <label htmlFor="email-content">كيف يمكنني مساعدتك ؟</label>
                <textarea id='email-content' onChange={(e) => setMessage(e.target.value)}/>
                <button onClick={(e) => handleSubmit(e)}>ارسل</button>
            </form>
            <Divider style={{borderColor: 'black', width: '100%'}}/>
            <div className='d-flex flex-column align-items-center w-100'> 
                <h3>أو تواصل معنا عبر الروابط</h3>
